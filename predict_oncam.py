...
def make_prediction(model_path):
    ...
    while True:
        ...
        faces_detected = classifier.detectMultiScale(img, 1.1, 6, minSize=(150, 150))
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Prection on Camera")
    parser.add_argument("--model_path", required=True, help="Model Path")
    args = parser.parse_args()
    make_prediction(args.model_path)